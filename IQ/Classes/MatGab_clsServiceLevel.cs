...
public class clsServiceLevel : i_Editable
{
	...
	public clsServiceLevel(int id, string mfrCode, int serviceLevel, string serviceLevelGroup, string superGroup, clsTranslation description, int duration, bool postWarranty, bool disabled, clsServiceType serviceType,

	clsResponse response, bool hpeDmr, bool hpeCdmr, bool hpiAdp, bool hpiDmr, bool hpiTravel, bool hpiTracing, bool hpiTheft)
	{
		this.ID = id;
	...
	public object i_Editable.Insert(ref List<string> errormessages)
	{
		...
		return new clsServiceLevel(this.ID, this.MfrCode, this.ServiceLevel, this.ServiceLevelGroup, this.SuperGroup, this.Description, this.Duration, this.PostWarranty, this.Disabled, this.ServiceType,
		this.Response, this.HpeDmr, this.HpeCdmr, this.HpiAdp, this.HpiDmr, this.HpiTravel, this.HpiTracing, this.HpiTheft);
	...
	{
		object sql = string.Format("update {0} set mfrCode='{1}', ServiceLevel={2}, ServiceLevelGroup='{3}', SuperGroup='{4}', Duration={5}, PostWarranty={6}, Disabled={7}, ServiceType={8}, Response={9}, DMR={10}, HpeDmr={11}, HpeCdmr={12}, HpiAdp={13}, HpiDmr={14}, HpiTravel={15}, HpiTracining={16}, HpiTheft={17) where ID={18}", TABLE, this.MfrCode, this.ServiceLevel, this.ServiceLevelGroup, this.SuperGroup, this.Duration, this.PostWarranty, this.Disabled, this.ServiceType.ID,
		this.Response.ID, this.HpiAdp, this.HpeDmr, this.HpeCdmr, this.HpiDmr, this.HpiTravel, this.HpiTracing, this.HpiTheft, this.ID);
