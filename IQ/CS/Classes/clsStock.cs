...
sql += "(" + System.Convert.ToString(SKUvariant.ID) + "," + System.Convert.ToString(Quantity) + "," + da.UniversalDate(Arrival) + ",getdate()," + System.Convert.ToString(iscurrent ? "1" : "0") + "," + da.SqlEncode(Source) + ");";
...
CoreCode.iq.stock.Add(this.ID, this);
...
public clsstock(int ID, clsVariant SKUVariant, int Quantity, DateTime Arrival, DateTime datestamp, bool isCurrent, System.Collections.Generic.List<string> errormessages)
{
...
if (CoreCode.iq.Stock.ContainsKey(this.ID))
{
