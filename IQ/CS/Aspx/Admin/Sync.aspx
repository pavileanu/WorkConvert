<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/site.master" CodeBehind="Sync.aspx.cs" Inherits="IQ.Sync" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../../scripts/jquery-1.11.2.min.js" type="text/javascript">
</script>
        <script src="../../scripts/jquery-ui-1.11.2.min.js" type="text/javascript">
</script> 
    <style>
        .skuElement {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnDoImport" ClientIDMode="Static"   Text="Import"  OnClientClick="importScan();return false;" runat="server" UseSubmitBehavior="false"    OnClick="btnDoImport_Click"/>

    <asp:Button ID="Button1" ClientIDMode="Static"   Text="submit results"  OnClientClick="SubmitResults();return false;" runat="server" UseSubmitBehavior="false"    OnClick="Button1_Click"/>
    <div id="logLines"></div>
