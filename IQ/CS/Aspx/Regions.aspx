<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Regions.aspx.cs" Inherits="IQ.Regions" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel3" runat="server" style="position:absolute;top:10px;left:420px;width:400px;">
            ...
            <asp:Button ID="BtnAddChild" runat="server" Text="Add a Child" ToolTip="Make a new region Inside this one"  OnClick="BtnAddChild_Click"/>
            <asp:Button ID="BtnSave" runat="server" Text="Save" Width="42px"  OnClick="BtnSave_Click"/>
        </asp:Panel>
    </div>
