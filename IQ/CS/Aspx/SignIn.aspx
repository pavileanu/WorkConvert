<%@ Page Title="iQuote" ValidateRequest="True" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="SignIn.aspx.cs" Inherits="IQ.SignIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="panelSignIn" ClientIDMode="Static" runat="server" style="display: inline-block;" NOBBLEDDefaultButton="btnSignIn">
        ...
        <div id="logonPanel" class="pwPanel ib" style="height:14em;width:30em;">
            ...
            <asp:Button ID="btnSignIn" CausesValidation ="true" runat="server" Text="Log in" CssClass="hpOrangeButton smallfont" OnClick="btnSignIn_Click" TabIndex="1" style="position:absolute;right:2em;top:14em;" OnClick="btnSignIn_Click"/>
            <asp:Button ID="BtnForgot" runat="server" Text="Forgotten Password" CssClass="hpGreyButton smallfont" style="position:absolute;left:1em;top:14em;"  OnClick="BtnForgot_Click"/>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="panelUniversal" ClientIDMode="Static" runat="server" style="display: inline-block; padding-left:5em; padding-bottom:3em;" Visible="false">
        ...
        <div id="registerPanel" class="pwPanel ib" style="height:14em;width:30em; border:1px solid #5A5A5A; margin:2em 0 2em 0;">
            ...
            <div id="selectHost" runat="server" style="float:left; width:40%; padding:1em;">
                ...
                <asp:Button ID="btnSignInUniversal" runat="server" Text="Log in" CssClass="hpOrangeButton smallfont" style="float:left;" OnClick="btnSignInUniversal_Click"/>
                <asp:Button ID="btnRegister" runat="server" Text="Register" CssClass="hpBlueButton smallfont" style="float:right;" OnClick="btnRegister_Click" OnCommand="btnRegister_Command"/>
            </div>
            ...
            <div style="float:left; width:45%; padding:1em;">
                ...
                <asp:Button ID="btnRequest" runat="server" Text="Request" CssClass="hpGreyButton smallfont" style="float:right;"  OnClick="btnRequest_Click"/>
