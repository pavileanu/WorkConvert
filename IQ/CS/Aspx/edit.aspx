<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="IQ.edit1" %>
...
<head runat="server">
   ...
   <link href="../Styles/dan.css" rel="stylesheet" type="text/css" />
    ...
    <link href="~/css/start/jquery-ui-1.8.21.custom.css" rel="stylesheet" type="text/css" />
        ...
        <script  src="../scripts/iQuote2-1.0.0.js" type="text/javascript">
</script> 
        <script src="../scripts/embed.js" type="text/javascript">
</script>
        <title>
    </title>
