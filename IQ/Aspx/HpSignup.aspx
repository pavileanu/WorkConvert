<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="HpSignup.aspx.vb" Inherits="IQ.HpSignup" %>
    ...
    <div class="mainDiv">
        ...
        <fieldset style="border: 0px currentColor; border-image: none;">
            ...
            <div class="containerStyle" id="accountSettings">
                ...
                <div class="divStyle">
                    <asp:Button ID="BtnSave" runat="server" CssClass="hpOrangeButton smallfont" />
                    <asp:Button ID="BtnCancel" runat="server" CssClass="hpOrangeButton smallfont" />
                </div>
