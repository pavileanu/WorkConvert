<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/Site.Master" CodeBehind="ValidationManager.aspx.vb" Inherits="IQ.ValidationManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" src="Resources/jqxcore.js"></script>
    <script type="text/javascript" src="Resources/jqxbuttons.js"></script>
    <script type="text/javascript" src="Resources/jqxscrollbar.js"></script>
    <script type="text/javascript" src="Resources/jqxmenu.js"></script>
    <script type="text/javascript" src="Resources/jqxgrid.js"></script>
    <script type="text/javascript" src="Resources/jqxdata.js"></script>
    <div>
