<%@ Page Title="Account Settings" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AccountSettings.aspx.vb" Inherits="IQ.AccountSettings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="accountSettings" class="mainDiv">
            ...
            <div id="container" class="containerStyle">
                <fieldset style="border: 0px currentColor; border-image: none;">
                    ...
                    <div class="divStyle">
                        <asp:Button ID="BtnSave" runat="server" Text="Save" CssClass="hpOrangeButton smallfont" />
                    </div>
    ...
    <script src="/Scripts/AccountSettings.js" type="text/javascript"></script>
</asp:Content>
