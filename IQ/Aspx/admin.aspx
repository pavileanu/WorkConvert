<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="admin.aspx.vb" Inherits="IQ.WebForm1"  EnableEventValidation ="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PnlMultiSend" runat="server" Visible="False">
        ...
        <asp:Button ID="btnGetStubs" runat="server" Text="Get Internals" />
                <asp:TextBox ID="TxtMultisend" runat="server" Width="676px"></asp:TextBox>
        <br />
        <asp:Button ID="BtnMultisend" runat="server" Text="Send Mails" />
        ...
        <div style ="float:left;">
            ...
            <div style ="padding-top : 20px;">
                ...
                <fieldset style="border: 0px currentColor; border-image: none;">
                    ...
                    <div class="divStyle">
                        <asp:Button ID="BtnSave" runat="server" enabled='<%= AccountCanSetupUsers.tostring%>'  Text="Save" CssClass="hpOrangeButton smallfont" />
