<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="administration.aspx.vb" Inherits="IQ.administration" MasterPageFile="~/Site.Master" EnableEventValidation ="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Menu ID="adminMenu" runat="server" Orientation="Horizontal" OnMenuItemClick="AdminMenu_MenuItemClick">
        <LevelMenuItemStyles>
    ...
    <asp:MultiView ID="adminMultiView" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="tabCreateUser" runat="server">
            ...
            <div>
                <div id="adminCreateUser" style="clear:both">
                    <fieldset>
                        ...
                        <div class="divStyle">
                            <asp:Button ID="BtnSave" runat="server" enabled='<%#AccountCanSetupUsers%>'  Text="Save" CssClass="hpOrangeButton smallfont" />
                        </div>
                    </fieldset>
                </div>
            </div>
            ...
            <asp:Panel ID="PnlMultiSend" CssClass="multiBox" runat="server" Visible="false">
                ...
                <asp:Button ID="btnGetStubs" CssClass="hpBlueButton smallfont" runat="server" Text="Get Internals" /><br /><br />
                List of emails to send:<asp:TextBox ID="TxtMultisend" cssclass="inputStyle " runat="server" Width="676px"></asp:TextBox>
                <asp:Button CssClass="hpBlueButton smallfont" ID="BtnMultisend" runat="server" Text="Send Mails" />
        ...
        <asp:View ID="tabSystem" runat="server">
            ...
            <asp:Panel ID="panelSignInMessage" CssClass="multiBox" runat="server" Visible="False">
                ...
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnAddSystemMessage" runat="server" Text="Save" Visible="False"/>
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnAmendSystemMessage" runat="server" Text="Save" Visible="False"/>
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnDeleteSystemMessage" runat="server" Text="Delete" Visible="False"/>
            </asp:Panel>
            ...
            <asp:Panel ID="panelHpeSystemMessage" CssClass="multiBox" runat="server" Visible="False">
                ...
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnAddHpeSystemMessage" runat="server" Text="Save" Visible="False"/>
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnAmendHpeSystemMessage" runat="server" Text="Save" Visible="False"/>
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnDeleteHpeSystemMessage" runat="server" Text="Delete" Visible="False"/>
            </asp:Panel>
            ...
            <asp:Panel ID="panelHpiSystemMessage" CssClass="multiBox" runat="server" Visible="False">
                ...
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnAddHpiSystemMessage" runat="server" Text="Save" Visible="False"/>
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnAmendHpiSystemMessage" runat="server" Text="Save" Visible="False"/>
                <asp:Button CssClass="hpBlueButton smallfont" ID="btnDeleteHpiSystemMessage" runat="server" Text="Delete" Visible="False"/>
            </asp:Panel>
            <br /><br />
        </asp:View>
